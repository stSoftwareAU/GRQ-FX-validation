...
// Version 1.0.103 - Correct pathname matching for data files (CSV + predictions.json)

const CACHE_NAME = "grq-fx-v1.0.103";
const STATIC_CACHE_NAME = "grq-fx-static-v1.0.103";
const DYNAMIC_CACHE_NAME = "grq-fx-dynamic-v1.0.103";
