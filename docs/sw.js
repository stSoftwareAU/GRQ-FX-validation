...
// Version 1.0.97 - Aggressive caching with version-based invalidation

const CACHE_NAME = 'grq-fx-v1.0.97';
const STATIC_CACHE_NAME = 'grq-fx-static-v1.0.97';
const DYNAMIC_CACHE_NAME = 'grq-fx-dynamic-v1.0.97';
